...
<div class="menubar_right_container">   
    ...
    <div class="col-bs-15 col-sm-2"><div class="men <?php echo ($path == 'slideshow/index' || $path == 'slideshow/add' || $path == 'slideshow/edit' || $path == 'slide/index' || $path == 'slide/add' || $path == 'slide/edit') ? 'active-btn' : ''; ?>"><a href="slideshow"><i class="fa fa-tachometer siz"></i><h3>Slide Show</h3></a></div></div>
</div>
