...
<div class="menubar_right_container">    
    ...
    <div class="col-bs-15 col-sm-2"><div class="men <?php echo ($path == 'applications') || ($path == 'applications/add') || ($path == 'applications/edit') ? 'active-btn' : ''; ?>"><a href="applications/applications"><i class="fa fa-cog siz"></i><h3>Applications</h3></a></div></div>    
    <div class="col-bs-15 col-sm-2"><div class="men <?php echo ($path == 'page') || ($path == 'applications/add') || ($path == 'applications/edit') ? 'active-btn' : ''; ?>"><a href="cms/page"><i class="fa fa-cog siz"></i><h3>Content</h3></a></div></div>    
    <div class="col-bs-15 col-sm-2"><div class="men <?php echo ($path == 'attributes') ? 'active-btn' : ''; ?>"><a href="units/attributes"><i class="fa fa-cog siz"></i><h3>Attributes</h3></a></div></div>    
