<div class="col-lg-12" style="background: white; border-radius: 5px;">
    ...
    <div class="row">
        ...
        <form id="cartFrm" name="cartFrm" method="post" action="<?= base_url(); ?>customer/cartupdate">
            <table class="table table-hover">
                ...
                <tr><td colspan="3"></td><td><button type="submit" class="btn btn-success"> Update Booking </button></td>
                    <td><a href="<?= base_url(); ?>customer/checkout/process"><button type="button" class="btn btn-success">Pay Now</button></a></td>
                </tr>
                </tbody>
            </table>
        </form>
