...
<div class="">
    <div class="box-header ui-sortable-handle">
        ...
        <h3 class="box-title"><a href="invoice/quaterly">Reports (Quarterly)</a></h3>
...
if(!empty($quarterly_data)){
foreach ($quarterly_data as $ev) { ?>
  <tr>
  <td><?=$i;?></td>
  ...
  <td><a href="invoice/quaterly/detail">View Detail</a></td>
