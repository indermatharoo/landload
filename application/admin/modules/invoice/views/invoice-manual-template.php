    ...
    <table width="729" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="padding:10px;">
            ...
            <td align="center" valign="middle">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 20px 0">
                    ...
                    <tr>
                        <td width="25%" align="left" style="line-height: 22px">
                            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:13px; text-transform:uppercase;">
                               <span><?php echo $inner["firstname"]." ".$inner["lastname"]; ?></span>
                            </font>
                        </td>
                        <td width="25%" align="right" style="line-height: 22px" >
                            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:red; font-size:15px; text-transform:uppercase;font-weight: 900;">
                                ...
                                <span><?php echo $inner["invoice_id"];?> </span>
                            </font>
                        </td>
                    </tr>
                     ...
                     <tr>
                        <td width="25%" align="left" style="line-height: 22px">
                            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:13px; text-transform:uppercase;">
                                ...
                                <span><?php echo $inner["home_address"];?></span>
                            </font>
                        </td>
                        <td width="25%" align="right" style="line-height: 22px">
                            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:13px; text-transform:uppercase;">
                                <strong>Payable Date: </strong>
                                <span> <?php echo date("d/m/Y",strtotime($inner["created_date"])); ?>   </span>
                            </font>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="25%" align="left" style="line-height: 22px">
                            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:13px; text-transform:uppercase;">
                                ...
                                <span><?php echo $inner["business_address"];?></span>
                            </font>
                        </td>
                        <td width="25%" align="right" style="line-height: 22px">
                            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:13px; text-transform:uppercase;">
                                <strong>Due Date: </strong>
                                <span> <?php echo $inner["due_date"];?> </span>
                            </font>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="25%" align="left" style="line-height: 22px">
                            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:13px; text-transform:uppercase;">
                                ...
                                <span><?php echo $inner["country"];?></span>
                            </font>
                        </td>
                        <td width="25%" align="right" style="line-height: 22px">
        ...
        <tr style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:16px;text-align: center;height:70px;">
            ...
            <td width="" style="-moz-border-bottom-colors: none;
                ...
                border-image: none;
                border-style: solid none solid solid;
                border-width: 1px 0 1px 1px;"> <?php echo $inner["particular"]; ?>  </td>
        
                    <td width="" style="
                        border-color: #000000 -moz-use-text-color #000000 #000000;
                        border-image: none;
                        border-style: solid none solid solid;
                        border-width: 1px 0 1px 1px;border-right:1px solid #000000;">  &pound;<?php echo $inner["installment_amount"]; ?> </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin-top: 0px; margin-bottom: 20px;">
                                <tr style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:16px;text-align: left; height:40px;">
                                    <td colspan="3"></td>
                                        ...
                                        <td width="15%" align="center"  style="border:1px solid #000000;border-top: 0;padding: 15px 0;">&pound;<?php echo $inner["installment_amount"];?></td>
                                </tr>

                                 <tr style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:16px;text-align: left; height:40px;">
                                    <td colspan="3"></td>
                                        <th width="20%" align="center"  style="color: #000; border:0;padding: 15px 0;">VAT 20%: </th>
                                        <td width="15%" align="center"  style="border:1px solid #000000;border-top: 0;padding: 15px 0;">&pound;<?php echo $inner["price_without_vat"]; ?>  </td>
                                </tr>
								<tr style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:16px;text-align: left; height:40px;">
                                    <td colspan="3"></td>
                                        ...
                                        <td width="15%" align="center"  style="border:1px solid #000000; border-top:none;color: #000;font-weight: 900;">&pound;<?php echo ($inner["installment_amount"]+$inner["price_without_vat"]); ?> </td>
                                </tr>		
