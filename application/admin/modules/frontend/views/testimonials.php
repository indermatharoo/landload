...
<div class="row content-bg">
    ...
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-sm-10">
                <h3 style="margin: 0; text-align: center">Testimonials</h3>
            </div>
            <div style="text-align: right" class="col-sm-1">
                <a href="frontend/testimonials/add"><h3 style="cursor: pointer; margin: 0; color: #fff"><i title="Add New user" class="fa fa-plus-square"></i></h3></a>
            </div>
        </div>
    </header>
...
//                    e($item);
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo createUrl('frontend/testimonials/add/' . arrIndex($item, 'id')); ?>">Edit</a> | 
                            <a href="<?php echo createUrl('frontend/testimonials/delete/' . arrIndex($item, 'id')); ?>">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
