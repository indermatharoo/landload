...
class Applicationsmodel extends Basemodel {
    ...
    function listAll($ids = array()) {
        $this->db->select('t1.id as application_id,t1.*,t2.*');
    ...
    function getUserDetails($id) {
        $this->db->select('applications.*,applicants.*,job_details.current_job,job_details.previous_job,job_details.experience');
        $this->db->from('applications');
