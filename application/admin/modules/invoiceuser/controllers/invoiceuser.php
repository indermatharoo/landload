...
class InvoiceUser extends Admin_Controller {
...
//*************************************validation End********************************
    ...
    function index() {
            ...
            if($ftype=='M'){
                ...
                //$inner["row"] = $temp;
                $inner['pagination'] = $this->pagination->create_links();
                $inner["weekly_data_detail"] = $this->invoicemodel->getMonthlyDetailInvoice(curUsrId());
                $page = array();
            ...
            if($ftype=='Q'){
               ...
               // $inner["row"] = $temp;
                $inner['pagination'] = $this->pagination->create_links();
                $inner["weekly_data_detail"] = $this->invoicemodel->getQuarterlyDetailInvoice(curUsrId());
                $page = array();
            ...
            if($ftype=='HY'){
              ...
              //  $inner["row"] = $temp;
                $inner['pagination'] = $this->pagination->create_links();
                $inner["weekly_data_detail"] = $this->invoicemodel->getHalfYearlyDetailInvoice(curUsrId());
                $page = array();
