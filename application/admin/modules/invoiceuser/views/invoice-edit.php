            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="form-group ">
                        ...
                        <input class="form-control" id="event_date" type="text" name="eventdate" value="<?= substr(str_replace('-', '/', $event['event_start_ts']), 0, 16) . ' - ' . substr(str_replace('-', '/', $event['event_end_ts']), 0, 16) ?>" />
                    </div>
                    <div class="form-group">
