<header class="panel-heading">
    <div class="row">
        <div class="col-sm-1" style="text-align: right">
            <a href="cms/menu_item/index/<?php echo $menu_detail['menu_id']; ?>"><h3 style="cursor: pointer; margin: 0; color: #fff"><i class="fa fa-arrow-left" title="Manage Menu Items"></i></h3></a>
        </div>
        <div class="col-sm-10">
            <h3 style="margin: 0; text-align: center">Add Menu Item</h3>
        </div>
        <div class="col-sm-1">
...
<div class="col-sm-12 padding-0" style="margin-top: 15px">
    <div id="cms">
        ...
        <form action="cms/menu_item/add/<?php echo $menu_detail['menu_id']; ?>" method="post" enctype="multipart/form-data" name="regFrm" id="regFrm">
