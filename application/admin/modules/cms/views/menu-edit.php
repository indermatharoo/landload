<header class="panel-heading">
    <div class="row">
        ...
        <div class="col-sm-2" style="text-align: right">
            <a href="cms/menu"><h3 style="cursor: pointer; margin: 0; color: #fff"><i class="fa fa-home" title="Manage Menu"></i></h3></a>
        </div>
    </div>
</header>
<div class="col-sm-12 padding-0 mar-top15">
    <?php $this->load->view(THEME . 'messages/inc-messages'); ?>
    <form action="cms/menu/edit/<?php echo $menu['menu_id']; ?>" method="post" enctype="multipart/form-data" name="addcatform" id="addcatform">
