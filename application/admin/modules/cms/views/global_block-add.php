            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9"><textarea name="block_contents" class="form-control editor" id="block_contents" cols="25" rows="5"><?php echo set_value('block_alias'); ?></textarea></div>
                    </div>
                    <div class="row">
