...
class Globalblockmodel extends CI_Model {
    ...
    function insertRecord() {
        ...
        if ($data['block_template']) {
            ...
            $status = file_put_contents("../application/views/" . THEME . "/blocks/" . $file_name, $block_template);
    ...
    function updateRecord($block) {
        ...
        if ($data['block_template']) {
            ...
            if ($old_file_name != $new_file_name) {
                //unlink the old file
                if (file_exists("../application/views/" . THEME . "/blocks/" . $old_file_name)) {
                    @unlink("../application/views/" . THEME . "/blocks/" . $old_file_name);
                }
            }

            $status = file_put_contents("../application/views/" . THEME . "/blocks/" . $new_file_name, $block_template);
