...
<div id="ctxmenu"><a href="setting/creditplans/index">Manage Credit Plans</a></div>
<?php $this->load->view(THEME.'messages/inc-messages'); ?>
<form action="setting/creditplans/edit/<?php echo $credit_plan['credit_plan_id']; ?>" method="post" enctype="multipart/form-data" name="addcatform" id="addcatform">
