<h1>Edit Form</h1>
<div id="ctxmenu"><a href="setting/form/index/">Forms Settings</a></div>
<?php $this->load->view(THEME.'messages/inc-messages');?>
<form action="setting/form/edit/<?php echo $form_details['form_alias'];?>" method="post" enctype="multipart/form-data" name="addalbumform" id="addalbumform">
