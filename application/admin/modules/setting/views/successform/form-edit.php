...
<div id="ctxmenu"><a href="setting/successform/index/">Forms Settings</a></div>
<?php $this->load->view(THEME.'messages/inc-messages');?>
<form action="setting/successform/edit/<?php echo $form_details['form_alias'];?>" method="post" enctype="multipart/form-data" name="addalbumform" id="addalbumform">
