...
<header class="panel-heading">
    <div class="row">
        ...
        <div class="col-sm-10">
            <h3 style="margin: 0; text-align: center">Add Company</h3>
        </div>
         ...
         <div class="form-group">
              <div class="col-sm-6">
                ...
                foreach ($country as $list){
                    ...
                    ?>
                <option value="<?php echo $list['id']; ?>"><?php echo $list['nicename']; ?></option>
                <?php
                }
                ?>
                </select>
             ...
             <div class="col-sm-6">
                ...
                ?>
                <?php echo form_dropdown('package',$options,'brone','class="form-control"'); ?>
            </div>
        </div>
