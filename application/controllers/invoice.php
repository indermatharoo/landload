...
class Invoice extends CI_Controller {
    ...
    function cron() {
        ...
        foreach ($rows as $row):
//            e($row);
            $this->invoicemodel->updateInvoice(arrIndex($row, 'invoice_id'));
...
//            e($row);
            $senddata = array(
                ...
                "invoice_no" => arrIndex($row, 'invoice_code'),
                "created_date" => $created_on,
                "due_date" => $due_on,
                "installment_amount" => arrIndex($row, 'installment_fees'),
                "vat_value" => arrIndex($row, 'vat'),
//                "after_vat" => $addvat,
                "after_vat" => arrIndex($row, 'total_amount'),
            );
//            e($senddata);
