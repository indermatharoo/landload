...
<?php if (DWS_GUARANTEE_POPUP_IMAGE) { ?>
        var DWS_GUARANTEE_POPUP_IMAGE = "<?php echo resize($this->config->item('SHOPPING_CART_URL') . DWS_GUARANTEE_POPUP_IMAGE, 200, 100, 'guaranatee_image'); ?>"
<?php } ?>
