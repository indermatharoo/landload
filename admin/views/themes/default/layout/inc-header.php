...
//                        e($franchise);
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="account">
                    <span style="font-style: normal;"><i class="fa fa-user"></i> Welcome <?php echo ucfirst($curUser->name);  ?></span> | <a href="<?= createUrl('user/logout') ?>"><span style="color: #170000;">Logout</span></a>
                </div> 
            </div>
        </div>
    </div>
