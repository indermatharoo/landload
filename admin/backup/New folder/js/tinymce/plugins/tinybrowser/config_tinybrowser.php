...
$_SESSION['tinybrowser']['sessioncheck'] = 'ENABLE_IMAGE_MANAGER'; // name of session variable to check
...
$_SESSION['tinybrowser']['docroot'] = rtrim($_SESSION['DWS_TINYBROWSER_PATH'],'/');
...
$_SESSION['tinybrowser']['path']['root'] = '/useruploads/'; // upload root directory
$_SESSION['tinybrowser']['path']['image'] = '/useruploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$_SESSION['tinybrowser']['path']['media'] = '/useruploads/media/'; // Media files location
$_SESSION['tinybrowser']['path']['file']  = '/useruploads/files/'; // Other files location
...
$_SESSION['tinybrowser']['link']['image'] = $_SESSION['DWS_TINYBROWSER_URL'].'images/'; // Image links
$_SESSION['tinybrowser']['link']['media'] = $_SESSION['DWS_TINYBROWSER_URL'].'media/'; // Banner links
$_SESSION['tinybrowser']['link']['file']  = $_SESSION['DWS_TINYBROWSER_URL'].'files/';
...
// size format: b, kb, mb
$_SESSION['tinybrowser']['maxsize']['image'] =  '2mb';// Image file maximum size
$_SESSION['tinybrowser']['maxsize']['media'] = '10mb' ; // Media file maximum size
$_SESSION['tinybrowser']['maxsize']['file']  = '10mb' ; // Other file maximum size
...
$_SESSION['tinybrowser']['thumbsrc'] = 'link'; // Possible values: path, link
...
$_SESSION['tinybrowser']['quota_check']  = true; // check user uploaded folder size
$_SESSION['tinybrowser']['max_quota']    = '50mb'; // should be adjusted to your needs
$_SESSION['tinybrowser']['max_quota_notified']  = false; // will alert the following email
